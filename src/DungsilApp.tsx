...
function Frame1({ onRefresh }: { onRefresh: () => void }) {
  return (
    <div className="content-stretch flex gap-[22px] h-[29.75px] items-center justify-center relative shrink-0 w-full">
      <p className="font-['Hakgyoansim_Dunggeunmiso_OTF:B',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#8faf3e] text-[18px] text-center text-nowrap whitespace-pre">오늘 둥실이의 한마디</p>
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[6px] items-center not-italic relative text-[#5c4033] text-center w-full">
        <p className="font-['Hakgyoansim_Dunggeunmiso_OTF:B',sans-serif] leading-[24px] relative text-[16px] w-full break-words">솔직함</p>
        <p className="font-['Hakgyoansim_Dunggeunmiso_OTF:R',sans-serif] leading-[15.125px] opacity-80 relative text-[12px] w-full break-words">
          {`실패도, 좌절도 숨기지 않아요 `}
          <br aria-hidden="true" />
...
function Frame30() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[6px] items-center not-italic relative text-[#5c4033] text-center w-full">
        <p className="font-['Hakgyoansim_Dunggeunmiso_OTF:B',sans-serif] leading-[24px] relative text-[16px] w-full break-words">회복력</p>
        <p className="font-['Hakgyoansim_Dunggeunmiso_OTF:R',sans-serif] leading-[15.125px] opacity-80 relative text-[12px] w-full break-words">
...
function Frame31() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[6px] items-center not-italic relative text-[#5c4033] text-center w-full">
        <p className="font-['Hakgyoansim_Dunggeunmiso_OTF:B',sans-serif] leading-[24px] relative text-[16px] w-full break-words">도전적</p>
        <p className="font-['Hakgyoansim_Dunggeunmiso_OTF:R',sans-serif] leading-[15.125px] opacity-80 relative text-[12px] w-full break-words">
          정말 많은 걸 하고 싶어 해요
          <br aria-hidden="true" />
...
function Frame24() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[17px] items-center left-[4.27%] right-[4.27%] top-[2320px] z-50">
      <p className="font-['Hakgyoansim_Dunggeunmiso_OTF:B',sans-serif] font-bold leading-[24px] not-italic text-[#8faf3e] text-[24px] text-center text-nowrap whitespace-pre mb-[30px]" style={{ fontWeight: 700 }}>둥실이의 대표 성격 3가지</p>
      <Frame21 />
      <Frame22 />
      <Frame23 />
    </div>
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-center not-italic relative shrink-0 text-[#5c4033] text-center w-full">
      <p className="font-['Hakgyoansim_Dunggeunmiso_OTF:B',sans-serif] font-bold leading-[24px] relative shrink-0 text-[16px] w-full">혼자 고민하고 있어?</p>
...
function Frame28() {
  return (
    <div className="absolute left-1/2 top-[1449px] -translate-x-1/2 w-full max-w-[430px] aspect-[430/827] z-10 overflow-hidden" data-name="Frame28">
      {/* 배경 이미지와 그라데이션 그룹 */}
      ...
      <div className="absolute content-stretch flex flex-col gap-[34px] items-center left-1/2 -translate-x-1/2 not-italic text-center top-[23.6%] w-[315px]">
        <p className="font-['Hakgyoansim_Dunggeunmiso_OTF:B',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#fff9f0] text-[24px] w-full">둥실이 이름 유래</p>
...
function Frame10({ onClick, isActive }: { onClick: () => void; isActive: boolean }) {
  return (
    <button onClick={onClick} className="content-stretch flex flex-col gap-[3px] items-center relative shrink-0 w-[47px] cursor-pointer">
      ...
      <p className={`font-['Pretendard:SemiBold',sans-serif] font-bold leading-[15px] min-w-full not-italic relative shrink-0 text-[10px] text-center w-[min-content] ${isActive ? 'text-[#8faf3e]' : 'text-[#5c4033]'}`}>Home</p>
    </button>
  );
}
...
function Frame9({ onClick, isActive }: { onClick: () => void; isActive: boolean }) {
  return (
    <button onClick={onClick} className="content-stretch flex flex-col gap-[3px] items-center relative shrink-0 w-[47px] cursor-pointer">
      ...
      <p className={`font-['Pretendard:SemiBold',sans-serif] font-bold leading-[15px] min-w-full not-italic relative shrink-0 text-[10px] w-[min-content] ${isActive ? 'text-[#8faf3e]' : 'text-[#5c4033]'}`}>Download</p>
    </button>
  );
}
...
function Frame8({ onClick, isActive }: { onClick: () => void; isActive: boolean }) {
  return (
    <button onClick={onClick} className="content-stretch flex flex-col gap-[3px] items-center relative shrink-0 w-[47px] cursor-pointer">
      ...
      <p className={`font-['Pretendard:SemiBold',sans-serif] font-bold leading-[15px] min-w-full not-italic relative shrink-0 text-[10px] text-center w-[min-content] ${isActive ? 'text-[#8faf3e]' : 'text-[#5c4033]'}`}>Talk</p>
    </button>
  );
}
...
function Frame7({ onClick, isActive }: { onClick: () => void; isActive: boolean }) {
  return (
    <button onClick={onClick} className="content-stretch flex flex-col gap-[3px] items-center relative shrink-0 w-[47px] cursor-pointer">
      ...
      <p className={`font-['Pretendard:SemiBold',sans-serif] font-bold leading-[15px] min-w-full not-italic relative shrink-0 text-[10px] w-[min-content] ${isActive ? 'text-[#8faf3e]' : 'text-[#5c4033]'}`}>Collection</p>
    </button>
  );
}
...
export default function App() {
  ...
  return (
    <>
      ...
      />
      <div className="flex justify-center items-start min-h-[100dvh] bg-[#f5f5f5] w-full overflow-x-hidden overflow-y-auto">
        <div className="bg-[#fff9f0] relative w-full max-w-[430px] h-[3638px] pb-[68px] overflow-x-hidden" data-name="홈" style={{ margin: '0 auto', touchAction: 'pan-y', boxShadow: 'window.innerWidth > 430 ? "0 0 20px rgba(0,0,0,0.1)" : "none"' }}>
          {/* 하단 고정 네비게이션 */}
          ...
          <motion.div className="absolute font-['Hakgyoansim_Dunggeunmiso_OTF:B',sans-serif] leading-[50px] left-1/2 not-italic text-[#fff9f0] text-[36px] text-center text-nowrap top-[87px] translate-x-[-50%] whitespace-pre"
            style={{ fontWeight: 700 }}
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 0.5, ease: "easeOut" }}
          >
            <p className="mb-0" style={{ fontWeight: 700 }}>{`안녕! `}</p>
            <p style={{ fontWeight: 700 }}>나는 둥실이야</p>
          </motion.div>
          <div className="absolute flex h-[250px] items-center justify-center left-0 top-[501px] w-full gradient-overlay" style={{ zIndex: -1 }}>
            <div className="flex-none rotate-[180deg] w-full">
              <div className="h-[250px] relative w-full">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 430 250">
                  <path d="M0 0H430V250H0V0Z" fill="url(#paint0_linear_1_486)" id="Rectangle 51" />
                  <defs>
                    <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_486" x1="215" x2="215" y1="230" y2="0">
          ...
          <div className="absolute flex h-[196px] items-center justify-center left-0 top-[2005px] w-full" style={{ zIndex: -1 }}>

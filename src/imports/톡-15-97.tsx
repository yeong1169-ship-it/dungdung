...
function LucideMenu() {
  return (
    <div className="absolute right-[16px] size-[24px] top-[59px]" data-name="lucide/menu">
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-end justify-center px-[16px] pt-[30px]">
      <Frame2 />
      <Frame />
    </div>
  );
...
function Frame4() {
  return (
    <div className="bg-[#8faf3e] box-border content-stretch flex gap-[10px] items-center justify-end px-[16px] py-[10px] rounded-bl-[10px] rounded-tl-[10px] rounded-tr-[10px] mt-[20px] mr-[16px] ml-auto max-w-[calc(75%-19.25px)]">
...
function Container2() {
  return (
    <div className="fixed bottom-0 left-0 right-0 box-border content-stretch flex flex-col items-start p-[16px] w-full bg-[#fff9f0] z-50" data-name="Container">
...
export default function Component() {
  return (
    <div className="bg-[#fff9f0] flex flex-col size-full overflow-hidden" data-name="톡">
      {/* Header - Fixed */}
      <div className="relative bg-[#D5C4B3] h-[92px] w-full shrink-0">
        <p className="absolute font-['Hakgyoansim_Dunggeunmiso_OTF:B',sans-serif] leading-[15.125px] left-[calc(50%-28.75px)] not-italic text-[#5c4033] text-[18px] text-nowrap top-[63px] whitespace-pre">둥실이</p>
        <LucideMenu />
        ...
        <div className="absolute h-0 left-0 bottom-0 w-full">

...
export function DungsilInfo() {
  return (
    <>
      <p className="absolute font-['Hakgyoansim_Dunggeunmiso_OTF:B',sans-serif] font-bold leading-[24px] left-[calc(50%-2.3px)] not-italic text-[#8faf3e] text-[24px] text-center text-nowrap top-[949px] translate-x-[-50%]">둥실이 소개</p>
      <Component2 />
      <Container19 />
      <Frame1 />
    </>

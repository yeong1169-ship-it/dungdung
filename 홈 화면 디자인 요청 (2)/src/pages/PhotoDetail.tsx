  ...
  return (
    <div className="flex justify-center items-start min-h-[100dvh] bg-[#fff9f0] w-full overflow-x-hidden overflow-y-auto">
      <div className="bg-[#fff9f0] relative w-full max-w-[430px] min-h-[100dvh] pb-[68px]" style={{ touchAction: "pan-y" }}>
        ...
        {/* 날짜 */}
        <p className="absolute font-['Hakgyoansim_Dunggeunmiso_OTF:R',sans-serif] leading-[20px] left-[calc(50%-43.5px)] not-italic text-[#5c4033] text-[16px] text-nowrap top-[110px] whitespace-pre">2000년 00월</p>
        ...
        {/* 사진 */}
        <div className="absolute bg-[#d9d9d9] h-[344px] left-[16px] right-[16px] rounded-[10px] top-[146px]" />

        {/* 좋아요 버튼 */}
        <button 
          onClick={() => setIsLiked(!isLiked)}
          className="absolute content-stretch flex items-center justify-center left-[calc(12.5%-18.88px)] size-[24px] top-[501px] translate-x-[-50%] cursor-pointer hover:opacity-70 transition-opacity"
        >
        ...
        {/* 텍스트 설명 */}
        <p className="absolute font-['Hakgyoansim_Dunggeunmiso_OTF:R',sans-serif] leading-[15.125px] left-[18px] not-italic text-[#5c4033] text-[14px] top-[536px] w-[343px]">
          오늘 00이 생일이라며!
          <br />
          정말 축하해!!
        </p>

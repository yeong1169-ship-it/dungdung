...
function GoodsImages() {
  return (
    <div className="absolute left-0 top-[329px] w-full max-w-[430px] bottom-[68px] overflow-hidden">
      <style>{`
    ...
    <div className="bg-[rgba(255,249,240,0.91)] content-stretch flex flex-col h-[68px] items-center justify-center w-full max-w-[430px] z-50 backdrop-blur-sm" data-name="BottomNav" style={{ position: 'fixed', bottom: 0, left: '50%', transform: 'translateX(-50%)' }}>
      ...
      <div className="content-stretch flex gap-[24px] items-center justify-center relative shrink-0 w-full px-[24px]">
        ...
        <button onClick={() => onNavigate("download")} className="content-stretch flex flex-col gap-[3px] items-center relative shrink-0 w-[47px] cursor-pointer hover:opacity-70 transition-opacity">
          <Icon2 />
          <p className="font-['Pretendard:SemiBold',sans-serif] leading-[15px] min-w-full not-italic relative shrink-0 text-[#5c4033] text-[10px] text-center w-[min-content]">Download</p>
        </button>
        ...
        <button onClick={() => onNavigate("collection")} className="content-stretch flex flex-col gap-[3px] items-center relative shrink-0 w-[47px] cursor-pointer hover:opacity-70 transition-opacity">
          <Icon4 />
          <p className="font-['Pretendard:SemiBold',sans-serif] leading-[15px] min-w-full not-italic relative shrink-0 text-[#5c4033] text-[10px] text-center w-[min-content]">Collection</p>
        </button>
...
export default function ShopPage({ onNavigate }: { onNavigate: (page: "home" | "download" | "talk" | "shop" | "collection" | "downloadDetail") => void }) {
  ...
  return (
    <div className="flex justify-center items-start min-h-[100dvh] bg-[#fff9f0] w-full overflow-x-hidden overflow-y-auto">
      <div className="bg-[#fff9f0] relative w-full max-w-[430px] min-h-[1250px] pb-[98px]" data-name="샵" style={{ touchAction: "pan-y" }}>

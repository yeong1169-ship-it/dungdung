import svgPaths from "./svg-m7zsogsw3q";
import img1 from "figma:asset/348e3a8eec568e3fbe96c6fc94e60e5aa5b4f94d.png";

function Rectangle1() {
  return (
    <div className="absolute h-[526px] left-0 top-0 w-[375px]">
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start leading-[15.125px] relative shrink-0 w-full">
      <p className="font-['Hakgyoansim_Dunggeunmiso_OTF:B',sans-serif] relative shrink-0 text-[#5c4033] text-[18px] w-full">배경화면 제목</p>
      <p className="font-['Hakgyoansim_Dunggeunmiso_OTF:R',sans-serif] relative shrink-0 text-[14px] text-[rgba(92,64,51,0.8)] w-full">2000. 00. 00</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-px items-center justify-center px-0 py-[16px] relative rounded-[10px] shrink-0 w-[110px]">
...
function Frame4() {
  return (
    <div className="bg-[#8faf3e] relative rounded-[10px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[rgba(92,64,51,0.2)] border-solid inset-0 pointer-events-none rounded-[10px]" />
    ...
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <div className="h-0 relative shrink-0 w-[343px]">
        <div className="absolute bottom-[-0.5px] left-0 right-0 top-[-0.5px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 343 1">
            <path d="M0 0.5H343" id="Line 2" stroke="var(--stroke-0, #5C4033)" strokeOpacity="0.2" />
          </svg>
        </div>
      </div>
      <Frame11 />
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 343 1">
            <line id="Line 3" stroke="var(--stroke-0, #5C4033)" strokeOpacity="0.2" x2="343" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame13() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[16px] top-[550px] w-[343px]">
      <Frame3 />
      <Frame12 />
    </div>
  );
...
function Frame2() {
  return (
    <div className="bg-white h-[243px] overflow-clip relative rounded-[16px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)] shrink-0 w-[164px]">
      <Rectangle />
      <Frame1 />
    </div>
  );
...
function Frame15() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[16px] top-[911px] w-[359px]">
...
export default function Component() {
  return (
    <div className="bg-[#fff9f0] relative size-full" data-name="다운로드 상세">
      <div className="absolute bottom-[59.02%] left-0 right-0 top-[0.08%]" data-name="가을의 산책 1">
      ...
      <Frame13 />
      <Frame15 />
      <div className="absolute flex items-center justify-center left-[16px] size-[24.03px] top-[55px]" style={{ "--transform-inner-width": "24", "--transform-inner-height": "24" } as React.CSSProperties}>
